...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="net_v2")
    parser.add_argument("--GPU_ID", type=int, default=0)
    # dataset
    parser.add_argument("--dataset_root", type=str, default="E:/data/casia_data/")
    parser.add_argument("--test_dataset", type=str, default="E:/data/casia_data/")
