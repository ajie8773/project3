...
class PAA_e(nn.Module):
    def __init__(self, in_channel):
        ...
        self.branch1 = PAA_kernel(in_channel, out_channel, 3, None)
        self.branch2 = PAA_kernel(in_channel, out_channel, 5, None)
        self.branch3 = PAA_kernel(in_channel, out_channel, 7, None)
